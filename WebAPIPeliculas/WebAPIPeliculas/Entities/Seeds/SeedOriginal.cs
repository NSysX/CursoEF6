...
{
    public static class SeedOriginal
    {
            public static void Seed(ModelBuilder modelBuilder)
            {
                ...
                var entidadGeneroPelicula = "PeliculaGenero";
                var generoIdPropiedad = "IdGenero";
                var peliculaIdPropiedad = "IdPelicula";

                var entidadSalaDeCinePelicula = "PeliculaSalaCine";
                var salaDeCineIdPropiedad = "IdSalaDeCine";
